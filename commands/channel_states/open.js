...
module.exports = {
    name: ['open'],
    description: "(hosts only) (server only) Opens the selected channel. If there is no open state, checks for category open state, or you can specify category.",
    ...
    execute(message, args, gameid)
    {
        ...
        for(var i = 0; i < channels.length; i++)
        {
            ...
            var perms = permissions.getopenpermissions(gameid, channelid);
