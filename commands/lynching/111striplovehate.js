...
module.exports = {
    name: ["striplovehate", "striplove", "striploved", "striphate", "striphated"],
    description: "(Host Only) Strips all loved and hated statuses from a player.",
    usage: "<user tag>",
    erased: false,
    securitylevel: "host",
    ...
    execute(message, args, gameid)
    {
        ...
        //remove love/hate
        lynching.removeLoveHate(gameid, targetid);
        return true;
    }
}